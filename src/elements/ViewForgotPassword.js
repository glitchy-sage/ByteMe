 ...
 */
class ViewForgotPassword extends View {
	...
	_webTemplate() {
		return html`
			<capitec-content-box>
				<capitec-label type="subtitle" label="Forgot Password"></capitec-label>
			</capitec-content-box>
		`;
	}
...
window.customElements.define(`view-forgot-password`, ViewForgotPassword);