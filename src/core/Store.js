import Dispatcher from '/src/elements/Dispatcher';
import { Observable } from 'rxjs';
import State from '/src/elements/State';
...
export class Store {
	 ...
	 * @returns {Object} Store state to return.
	 */
	getStateProperty(propertyName, deepCloneReturnedState = true) {
	 ...
	 */
	setState(state, action, dispatchState = true, deepCloneState = true) {
	 ...
	 * @returns {void}
	 */
	resetState(state, dispatchState = true) {
	...
	_dispatchState(stateChanges, name) {
		...
		Dispatcher.getStateChangedNoPayloadDispatcher(this._settings).next();
